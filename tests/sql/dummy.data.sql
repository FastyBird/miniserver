INSERT IGNORE INTO `fb_devices_module_connectors` (`connector_id`, `connector_name`, `connector_key`, `connector_enabled`, `connector_type`, `created_at`, `updated_at`)
...
INSERT IGNORE INTO `fb_devices_module_devices_properties` (`property_id`, `device_id`, `property_type`, `property_key`, `property_identifier`, `property_name`, `property_settable`, `property_queryable`, `property_data_type`, `property_unit`, `property_format`, `property_invalid`, `property_number_of_decimals`, `property_value`, `created_at`, `updated_at`)
...
INSERT IGNORE INTO `fb_devices_module_channels` (`channel_id`, `device_id`, `channel_key`, `channel_name`, `channel_comment`, `channel_identifier`, `params`, `created_at`, `updated_at`)
...
INSERT IGNORE INTO `fb_devices_module_channels_properties` (`property_id`, `channel_id`, `property_type`, `property_key`, `property_identifier`, `property_name`, `property_settable`, `property_queryable`, `property_data_type`, `property_unit`, `property_format`, `property_invalid`, `property_number_of_decimals`, `property_value`, `created_at`, `updated_at`)
