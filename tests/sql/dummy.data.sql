...
VALUES (_binary 0x17C59DFA2EDD438E8C49FAA4E38E5A5E, 'FB MQTT', 'fb-mqtt', '2020-03-20 09:18:20', '2020-03-20 09:18:20');

INSERT IGNORE INTO `fb_devices` (`device_id`, `parent_id`, `device_identifier`, `device_key`, `device_name`, `device_comment`, `device_enabled`, `device_hardware_manufacturer`, `device_hardware_model`, `device_hardware_version`, `device_hardware_mac_address`, `device_firmware_manufacturer`, `device_firmware_version`, `params`, `created_at`, `updated_at`, `owner`)
...
INSERT IGNORE INTO `fb_devices_properties` (`property_id`, `device_id`, `property_key`, `property_identifier`, `property_name`, `property_settable`, `property_queryable`, `property_data_type`, `property_unit`, `property_format`, `created_at`, `updated_at`)
VALUES (_binary 0xBBCCCF8C33AB431BA795D7BB38B6B6DB, _binary 0x69786D15FD0C4D9F937833287C2009FA, 'bLikpV', 'uptime', 'uptime', 0, 1, 'int', NULL, NULL, '2020-03-20 09:18:20', '2020-03-20 09:18:20'),
...
INSERT IGNORE INTO `fb_devices_configuration` (`configuration_id`, `device_id`, `configuration_key`, `configuration_data_type`, `configuration_identifier`, `configuration_name`, `configuration_comment`, `configuration_default`, `created_at`, `updated_at`, `params`)
VALUES (_binary 0x138C6CFCED49476B9F1E6EE1DCB24F0B, _binary 0x69786D15FD0C4D9F937833287C2009FA, 'bLikmS', 'int', 'sensor_expected_power', NULL, NULL, NULL, '2019-11-26 18:59:07', '2019-12-10 20:35:50', '{"min_value":0,"max_value":500,"step_value":1}'),
...
INSERT IGNORE INTO `fb_devices_connectors` (`device_connector_id`, `device_id`, `connector_id`, `params`, `created_at`, `updated_at`)
VALUES (_binary 0x7C055B2B60C3401793DBE9478D8AA662, _binary 0x69786D15FD0C4D9F937833287C2009FA, _binary 0x17C59DFA2EDD438E8C49FAA4E38E5A5E, '{"username":"deviceusrname","password":"supersecretpassword"}', '2020-03-20 09:18:20', '2020-03-20 09:18:20');
...
VALUES (_binary 0x17C59DFA2EDD438E8C49FAA4E38E5A5E, _binary 0x69786D15FD0C4D9F937833287C2009FA, 'bLikxh', 'Channel one', NULL, 'channel-one', '[]', '2020-03-20 09:22:12', '2020-03-20 22:37:14'),
...
INSERT IGNORE INTO `fb_channels_properties` (`property_id`, `channel_id`, `property_key`, `property_identifier`, `property_name`, `property_settable`, `property_queryable`, `property_data_type`, `property_unit`, `property_format`, `created_at`, `updated_at`)
VALUES (_binary 0xBBCCCF8C33AB431BA795D7BB38B6B6DB, _binary 0x17C59DFA2EDD438E8C49FAA4E38E5A5E, 'bLikx4', 'switch', 'switch', 1, 1, 'enum', NULL, 'on,off,toggle', '2019-12-09 23:19:45', '2019-12-09 23:19:49'),
...
INSERT IGNORE INTO `fb_channels_configuration` (`configuration_id`, `channel_id`, `configuration_key`, `configuration_data_type`, `configuration_identifier`, `configuration_name`, `configuration_comment`, `configuration_default`, `created_at`, `updated_at`, `params`)
VALUES (_binary 0x008D911FE6D44B17AA28939839581CDE, _binary 0x17C59DFA2EDD438E8C49FAA4E38E5A5E, 'bLikxT', 'enum', 'pulse_mode', NULL, NULL, '0', '2019-12-09 23:19:46', '2019-12-09 23:19:46', '{"select_values":[{"value":"0","name":"disabled"},{"value":"1","name":"normally_off"},{"value":"2","name":"normally_on"}]}'),
