...
Sonoff NS Panel PRO connector is tested against PHP 8.4 and require installed [Process Control](https://www.php.net/manual/en/book.pcntl.php) PHP extension.
