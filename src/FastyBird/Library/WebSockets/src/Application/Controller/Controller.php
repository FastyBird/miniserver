...
abstract class Controller implements IController
{
	 ...
	 * @throws Exceptions\BadSignal
	 * @throws Exceptions\ForbiddenRequest
		...
		try {
			...
			if ($this->signal !== null) {
				if (!$this->tryCall(call_user_func([$this, 'formatSignalMethod'], $this->signal), $this->params)) {
					...
					throw new Exceptions\BadSignal(
	...
	public function checkRequirements(mixed $element): void
	{
		...
		if (in_array('loggedIn', $user, true) && !$this->getUser()->isLoggedIn()) {
			throw new Exceptions\ForbiddenRequest();
		}
	}
