...
final class HandshakeVerifier
{
	...
	public function verifyAll(Http\IRequest $httpRequest): bool
	{
		...
		$passes += (int) $this->verifyVersion(
			(int) $httpRequest->getHeader('Sec-WebSocket-Version'),
		); // Temporarily breaking functionality
	 ...
	 */
	public function verifyHttpVersion(float|null $val = null): bool
	{
		return $val && $val >= 1.1;
	}
	 ...
	 *       $_SERVER['HOST'] ?
	 */
	public function verifyHost(string|null $val = null): bool
	{
		return $val !== null;
	}
	 ...
	 */
	public function verifyKey(string|null $val = null): bool
	{
