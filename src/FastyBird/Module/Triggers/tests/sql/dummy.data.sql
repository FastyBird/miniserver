...
INSERT INTO `fb_triggers_module_conditions` (`condition_id`, `trigger_id`, `created_at`, `updated_at`, `condition_type`, `condition_watch_item`, `condition_operator`, `condition_operand`) VALUES
...
INSERT INTO `fb_triggers_module_actions` (`action_id`, `trigger_id`, `action_type`, `created_at`, `updated_at`, `action_do_item`, `action_value`) VALUES
