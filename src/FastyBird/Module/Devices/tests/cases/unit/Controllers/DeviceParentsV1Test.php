...
final class DeviceParentsV1Test extends Tests\Cases\Unit\DbTestCase
{
	...
	public static function deviceParentsRead(): array
	{
		return [
			...
			//////////////////
			'readAll' => [
				'/api/' . Constants::MODULE_DEVICES_PREFIX . '/v1/devices/a1036ff8-6ee8-4405-aaed-58bae0814596/parents',
			...
			'readAllPaging' => [
				...
				'/api/' . Constants::MODULE_DEVICES_PREFIX . '/v1/devices/a1036ff8-6ee8-4405-aaed-58bae0814596/parents?page[offset]=1&page[limit]=1',
				'Bearer ' . self::VALID_TOKEN,
				StatusCodeInterface::STATUS_OK,
			...
			'readRelationshipsUnknownDevice' => [
				'/api/' . Constants::MODULE_DEVICES_PREFIX . '/v1/devices/28bc0d38-2f7c-4a71-aa74-27b102f8dfc4/parents',
				'Bearer ' . self::VALID_TOKEN,
