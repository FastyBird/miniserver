...
final class ConstantsTest extends TestCase
{
	...
	public function testValueFormatStringEnum(): void
	{
		...
		self::assertSame(1, preg_match(
			Constants\Constants::VALUE_FORMAT_STRING_ENUM,
			'one,two,three',
		));
		self::assertSame(1, preg_match(
			Constants\Constants::VALUE_FORMAT_STRING_ENUM,
	...
	public function testValueFormatNumberRange(): void
	{
		// Valid
		self::assertSame(1, preg_match(
			Constants\Constants::VALUE_FORMAT_NUMBER_RANGE,
			'10:20',
		));
		self::assertSame(1, preg_match(
			Constants\Constants::VALUE_FORMAT_NUMBER_RANGE,
	...
	public function testValueFormatCombinedEnum(): void
	{
		// Valid
		self::assertSame(1, preg_match(
			Constants\Constants::VALUE_FORMAT_COMBINED_ENUM,
	...
	public function testValueEquationTransform(): void
	{
		// Valid
		self::assertSame(1, preg_match(
			Constants\Constants::VALUE_EQUATION_TRANSFORMER,
			'equation:x=10y + 2',
		));
		self::assertSame(1, preg_match(
			Constants\Constants::VALUE_EQUATION_TRANSFORMER,
