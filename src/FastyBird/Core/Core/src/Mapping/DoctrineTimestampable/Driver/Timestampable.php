...
use FastyBird\Core\Mapping\DoctrineTimestampable\Annotation\Timestampable as AnnotationTimestampable;
...
final class Timestampable
{
	...
	private const string EXTENSION_ANNOTATION = AnnotationTimestampable::class;
