...
abstract class QueryObject
{
	...
	): int
	{
		...
		} catch (PersistenceExceptions\QueryNotImplemented) {
			// Nothing to do here
		}
	...
	/**
	 * @throws PersistenceExceptions\QueryNotImplemented
	 *
	 * @phpstan-param ORM\EntityRepository<TEntityClass> $repository
	 */
	...
	{
		throw new PersistenceExceptions\QueryNotImplemented('Method doCreateCountQuery is not implemented');
	}
	...
	): ResultSet|array
	{
		try {
			...
			throw new PersistenceExceptions\Query(
				$ex,
				$this->getLastQuery(),
